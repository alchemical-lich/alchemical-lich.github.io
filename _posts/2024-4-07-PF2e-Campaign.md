...
- They move through another set of double doors and find a former war room. Behind a large table, a spidery lurker creature beckons them inside. Communicating through gestures, it accepts a magical warhammer as tribute and commands Arryn to polish its claws. After Arryn shows obedience, it dismisses the others and commands Arryn to complete additional tasks. Arryn spies a stash of valuables under the table. The spider creature activates an illusory map of Absalom on the table and begins to study it. Arryn attempts to make more overtures but only angers the beast. The creature approaches to teach Arryn a lesson...
